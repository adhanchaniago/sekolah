  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Tambah Staf</h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="card">
              ...
              <div class="card-body">
                <?php echo form_open('admin/dasbor/direktori_staf_add/','role="form"');?>
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      <label>NIP</label>
                      <?php echo form_input('nip/nis','','class="form-control" placeholder="NiP"');?>
                    </div>
                    <div class="form-group">
                      ...
                      <select class="form-control" name="studi">
                        ...
                        <?php foreach($bidang_studi_list  as $bid){ ?>
                          <option value="<?php echo $bid['id']?>" 
                            <?php echo set_select('studi', $bid['name']);?>>
                            <?php echo $bid['name']?>
                          </option>
                        <?php }?>
                      </select>
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group input-group-sm">
                        <input type="text" id="as" value="" name="foto" class="form-control">
