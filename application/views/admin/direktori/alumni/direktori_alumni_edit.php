        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="card">
              ...
              <div class="card-body">
                <?php foreach($direktori_alumni_edit  as $row){ ?>
                <?php echo form_open('admin/dasbor/direktori_alumni_update/'.$row['id'],'role="form"');?>
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <?php echo form_input('tahun_lulus',$row['tahun_lulus'],'class="form-control" placeholder="Tahun Lulus"');?>
                    </div>
                    <div class="form-group">
                      <label>Tempat</label>
