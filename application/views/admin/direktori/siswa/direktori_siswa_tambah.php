        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="card">
              ...
              <div class="card-body">
                <?php echo form_open('admin/dasbor/direktori_siswa_add/','role="form"');?>
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      <label>NIS</label>
                      <?php echo form_input('nis','','class="form-control" placeholder="NIS"');?>
                    </div>
                    <div class="form-group">
                      <label>Kelas</label>
                    ...
                    <div class="form-group">
                      <label>Kelas</label>
                      <?php echo form_input('kelas','','class="form-control" placeholder="Kelas"');?>
                    </div>
                    <div class="form-group">
                      <label>Tempat</label>
