        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="card">
              ...
              <div class="card-body">
                <?php foreach($direktori_siswa_edit  as $row){ ?>
                <?php echo form_open('admin/dasbor/direktori_siswa_update/'.$row['id'],'role="form"');?>
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      <label>NIS</label>
                      <?php echo form_input('nis',$row['nis'],'class="form-control" placeholder="NIS"');?>
                    </div>
                    <div class="form-group">
                      <label>Kelas</label>
                      <select class="form-control" name="kelas">
                        <option value="">Pilih Kelas</option>
                        <option <?php if ($row['kelas'] == 1 ) echo 'selected' ; ?> value="1">1</option>
                        <option <?php if ($row['kelas'] == 2 ) echo 'selected' ; ?> value="2">2</option>
                        <option <?php if ($row['kelas'] == 3 ) echo 'selected' ; ?> value="3">3</option>
                        <option <?php if ($row['kelas'] == 4 ) echo 'selected' ; ?> value="4">4</option>
                        <option <?php if ($row['kelas'] == 5 ) echo 'selected' ; ?> value="5">5</option>
                        <option <?php if ($row['kelas'] == 6 ) echo 'selected' ; ?> value="6">6</option>
                      </select>
                    </div>
