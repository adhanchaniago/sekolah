        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="card">
              ...
              <div class="card-body">
                <?php foreach($galeri_edit  as $row){ ?>
                <?php echo form_open('admin/dasbor/galeri_update/'.$row['id'],'role="form"');?>
                  <div class="card-body">
                    <div class="form-group">
                      ...
                      <select class="form-control" name="banner_category_id">
                        ...
                        <?php foreach($kategori as $ros){ ?>
                          <option <?php if($ros['id'] == $row['banner_category_id']){ echo 'selected="selected"'; }?> 
