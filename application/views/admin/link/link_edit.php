  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Edit Link</h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="card">
              ...
              <div class="card-body">
                <?php foreach($link_edit  as $row){ ?>
                <?php echo form_open('admin/dasbor/link_update/'.$row['id'],'role="form"');?>
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      <label>URL</label>
                      <?php echo form_input('url',$row['url'],'class="form-control" placeholder="URL"');?>
                    </div>
