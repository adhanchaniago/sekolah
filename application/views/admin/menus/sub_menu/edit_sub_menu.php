  			...
  			<div class="row">
  				<div class="col-12">
  					...
  					<div class="card">
  						...
  						<div class="card-body">
  							<?php foreach ($edit_sub_menu  as $row) { ?>
  								<?php echo form_open('admin/menus/submenu/update_sub_menu/' . $row['id'], 'role="form"'); ?>
  								<div class="card-body">
  									<div class="form-group">
  										...
  										<select class="form-control" name="menu_parent_id">
  											...
  											<?php foreach ($menu as $m) { ?>
  												<option <?php if ($row['menu_parent_id'] == $m['id']) {
																echo 'selected="selected"';
															} ?> value="<?php echo $m['id'] ?>"><?php echo $m['menu_title'] ?></option>
  											<?php } ?>
  										</select>
  									</div>
  									<div class="form-group">
