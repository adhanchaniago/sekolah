  ...
  <div class="content-wrapper">
  	...
  	<div class="content-header">
  		<div class="container-fluid">
  			<div class="row mb-2">
  				<div class="col-sm-6">
  					<h1 class="m-0 text-dark">Tambah Sub Menu</h1>
  				</div><!-- /.col -->
  			</div><!-- /.row -->
  		</div><!-- /.container-fluid -->
  	</div>
  			...
  			<div class="row">
  				<div class="col-12">
  					...
  					<div class="card">
  						...
  						<div class="card-body">
  							<?php echo form_open('admin/menus/submenu/add_sub_menu', 'role="form"'); ?>
  							<div class="card-body">
  								<div class="form-group">
  									...
  									<select class="form-control" name="menu_parent_id">
  										...
  										<?php foreach ($menu as $m) { ?>
  											<option value="<?php echo $m['id'] ?>"><?php echo $m['menu_title'] ?></option>
  										<?php } ?>
  									</select>
  								</div>
  								<div class="form-group">
